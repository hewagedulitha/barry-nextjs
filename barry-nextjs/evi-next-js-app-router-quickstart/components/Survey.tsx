...
export default function Survey({history, setHistory, setShowSurvey} : { 
  ...
  return (
    <div className="w-screen h-screen flex justify-center overflow-auto">  
            <div className=" w-3/4 block p-6 py-8 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
